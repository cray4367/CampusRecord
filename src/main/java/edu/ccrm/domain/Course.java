...
/**
 * Immutable-ish CourseCode wrapper demonstration could be added later.
 * Course has builder as requested (simple inner static builder).
 */
public class Course {
    ...
    public String toString() {
        return String.format("%s - %s (%dcr) [%s] Dept:%s", code, title, credits, semester, department);
    }
